    ...
    <div className="flex">
      ...
      <div>
        <button
          ...
          className="mx-1 p-1.5 rounded-md bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors duration-200 shadow-sm border border-gray-300 dark:border-gray-700"
        >
          <Plus />
        </button>
      </div>
